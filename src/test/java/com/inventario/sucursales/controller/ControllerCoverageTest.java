...
class ControllerCoverageTest {
    ...
    void setUp() {
        ...
        sampleProduct = new Product(1L, "PROD-01", "Laptop Pro", "Desc", "Electrónica", new BigDecimal("15000"), "Pza", 5, true);
    }
    ...
    void testInventoryControllerRead() throws Exception {
        ...
        InventoryAlertDto alert = new InventoryAlertDto(1L, 1L, "CDMX Norte", 1L, "Laptop Pro", "PROD-01", "Electrónica", 3, 5);
    ...
    void testRequestControllerReadAndCreate() throws Exception {
        User reqUser = new User(2L, "gerente_cdmx", "pass", "Ana", "a@test.com", Role.ROLE_GERENTE, sampleBranch, "Gerente", "123", true);
        InventoryRequest req = new InventoryRequest(1L, RequestType.TRANSFER, null, sampleBranch, sampleProduct, 10, RequestStatus.PENDING, reqUser, null, "Nota", null, LocalDateTime.now(), null);
    ...
    void testRequestControllerApproveAndRejectAdmin() throws Exception {
        User reqUser = new User(2L, "gerente_cdmx", "pass", "Ana", "a@test.com", Role.ROLE_GERENTE, sampleBranch, "Gerente", "123", true);
        InventoryRequest req = new InventoryRequest(1L, RequestType.TRANSFER, null, sampleBranch, sampleProduct, 10, RequestStatus.APPROVED, reqUser, null, "Nota", "Ok", LocalDateTime.now(), LocalDateTime.now());
    ...
    void testEmployeeControllerCrudAdmin() throws Exception {
        User emp = new User(1L, "emp1", "pass", "Empleado 1", "e@test.com", Role.ROLE_GERENTE, sampleBranch, "Puesto", "123", true);
        EmployeeDto dto = new EmployeeDto(null, "emp1", "pass", "Empleado 1", "e@test.com", Role.ROLE_GERENTE, 1L, "Puesto", "123", true);
